...
- Generated: 2026-08-03T18:56:50.443Z
- Application version: 1.1.21
...
- **FAIL** - Party statement includes only payments from the requested financial year
  Evidence: Requested 2026-27; statement closing balance -1298; expected 0.00 for the settled in-year invoice.
...
- **PASS** - Multi-year report endpoints remain responsive on the isolated audit database
  Evidence: 15 API samples; p50 13.76 ms; p95 45.2 ms; max 45.2 ms.
...
- **FAIL** - Operational audit agent completed with an execution error
  Evidence: Error: spawn EINVAL
    at ChildProcess.spawn (node:internal/child_process:441:11)
    at spawn (node:child_process:796:9)
    at C:\Users\user\Documents\Codex\2026-06-18\tarangini-job-order-integration\fresh-merged-billing-workflow\tools\run-operational-audit-agent.js:127:19
    at new Promise (<anonymous>)
    at runCommand (C:\Users\user\Documents\Codex\2026-06-18\tarangini-job-order-integration\fresh-merged-billing-workflow\tools\run-operational-audit-agent.js:125:10)
    at runFullRegressionSuites (C:\Users\user\Documents\Codex\2026-06-18\tarangini-job-order-integration\fresh-merged-billing-workflow\tools\run-operational-audit-agent.js:155:66)
    at main (C:\Users\user\Documents\Codex\2026-06-18\tarangini-job-order-integration\fresh-merged-billing-workflow\tools\run-operational-audit-agent.js:498:36)
    at process.processTicksAndRejections (node:internal/process/task_queues:104:5)
  Upgrade: Fix the failing endpoint or audit fixture before relying on this report for a release decision.
...
- **P0** - Fix the failing endpoint or audit fixture before relying on this report for a release decision. (audit_agent_execution)
