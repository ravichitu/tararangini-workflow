...
- Generated: 2026-08-06T19:58:20.488Z
...
- **PASS** - Party statement scopes entries to the requested financial year and carries historic debt into opening balance once
  Evidence: Requested 2026-27; entries scoped true; opening 118; closing 118; historic outstanding 118.
  Upgrade: Keep party-statement payments filtered by financial year and calculate an explicit opening balance from all transactions before the requested period; retain this multi-year regression test.
...
- **PASS** - Multi-year report endpoints remain responsive on the isolated audit database
  Evidence: 15 API samples; p50 14.57 ms; p95 32.29 ms; max 32.29 ms.
