...
- Generated: 2026-08-03T18:52:41.920Z
...
- **FAIL** - Stock balance equals opening stock plus source-linked movements across all tested years
  Evidence: Opening stock 100; qty out 0; current stock 87; expected 87.
...
- **PASS** - Multi-year report endpoints remain responsive on the isolated audit database
  Evidence: 15 API samples; p50 17.56 ms; p95 43.3 ms; max 43.3 ms.
...
- **P0** - Add a scheduled stock-movement reconciliation report that compares item balances, movement sources, returns, and job-material consumption. (stock_movement_reconciliation)
